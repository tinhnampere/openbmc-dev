...
SYSTEMD_ENVIRONMENT_FILE:${PN} += " obmc/gpio/psu0_present \
                                    obmc/gpio/psu1_present \
                                  "
SYSTEMD_SERVICE:${PN} = "psu-inventory-update@.service"
SYSTEMD_SERVICE:${PN} += " psu-inventory-update@0.service"
SYSTEMD_SERVICE:${PN} += " psu-inventory-update@1.service"
