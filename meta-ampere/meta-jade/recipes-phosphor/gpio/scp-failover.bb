...
# via GPIO assertion
SYSTEMD_ENVIRONMENT_FILE:${PN} +="obmc/gpio/s0_scp_auth_failure \
                                 "
...
SYSTEMD_SERVICE:${PN} ?= "scp_failover.service"
...
SYSTEMD_LINK:${PN} += "${@compose_list(d, 'MONITOR_FMT', 'OBMC_HOST_MONITOR_INSTANCES')}"
