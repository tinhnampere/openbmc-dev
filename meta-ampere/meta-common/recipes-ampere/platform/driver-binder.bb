...
SRC_URI = " \
           file://power-on-driver-binder@.service \
           file://host-on-driver-binder@.service \
          "

SYSTEMD_PACKAGES = "${PN}"
SYSTEMD_SERVICE:${PN} = " \
                         power-on-driver-binder@.service \
                         host-on-driver-binder@.service \
                        "
# bind driver after the power is on
POWER_ON_DRIVER_BINDER_TGT = "power-on-driver-binder@.service"
POWER_ON_DRIVER_BINDER_INSTMPL = "power-on-driver-binder@{0}.service"
...
HOST_ON_DRIVER_BINDER_TGT = "host-on-driver-binder@.service"
HOST_ON_DRIVER_BINDER_INSTMPL = "host-on-driver-binder@{0}.service"
