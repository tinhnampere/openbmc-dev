...
# via GPIO assertion
SYSTEMD_ENVIRONMENT_FILE:${PN} +="obmc/gpio/overtemp_S0 \
...
SYSTEMD_SERVICE:${PN} ?= "ampere_hightemp_start.service ampere_hightemp_stop.service ampere_overtemp.service"
